...
QT_MOC_LITERAL(3, 17, 3), // "pix"
QT_MOC_LITERAL(4, 21, 4), // "path"
QT_MOC_LITERAL(5, 26, 13) // "coord_texture"

    },
    "MyLabel\0clicked\0\0pix\0path\0coord_texture"
};
...
static const uint qt_meta_data_MyLabel[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QPixmap, QMetaType::Int, QMetaType::QString,    3,    5,    4,
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< const QPixmap(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->clicked((*reinterpret_cast< const QPixmap(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyLabel::*)(const QPixmap & , QString );
        ...
        {
            using _t = void (MyLabel::*)(const QPixmap & , int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::clicked)) {
                *result = 1;
                return;
            }
...
// SIGNAL 0
void MyLabel::clicked(const QPixmap & _t1, QString _t2)
{
...
// SIGNAL 1
void MyLabel::clicked(const QPixmap & _t1, int _t2, QString _t3)
{
